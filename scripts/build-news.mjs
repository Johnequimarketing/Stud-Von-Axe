...
${rootBlock}
  *{ box-sizing:border-box; }
  ...
  /* ---- the archive hero: a covered photograph, the homepage's own
          veil recipe. Heavy on the left where the type sits, open on the
          right where the picture is worth seeing. ---- */
  .nhero{
  ...
  .nhero__veil{
    ...
    background:linear-gradient(100deg,
      rgba(6,12,20,.92) 0%, rgba(10,21,38,.82) 44%, rgba(10,21,38,.45) 100%);
  }
  .nhero > .wrap{ position:relative; z-index:2; padding-block:clamp(2.2rem,5vw,3.4rem); }
  .nhero .plaque{ color:var(--color-gold); }
  .arch__h{
  ...
  .arch__intro{ margin:.9rem 0 0; color:rgba(255,255,255,.78); max-width:56ch; font-size:15.5px; }
...
<section class="nhero">
  <div class="nhero__bg" aria-hidden="true">
    <img src="../assets/img/hero-cortina-wide.jpg" alt="" fetchpriority="high">
  </div>
