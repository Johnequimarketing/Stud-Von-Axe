...
mkdir -p "$here/assets/img/horses" "$here/assets/logo"
rm -f "$here/assets/img/"*.jpg "$here/assets/img/"*.png "$here/assets/img/horses/"* "$here/assets/logo/"*
count=0
while IFS= read -r ref; do
  ...
  | grep -oE 'assets/(img/horses|img|logo)/[A-Za-z0-9._-]+' | sort -u)
