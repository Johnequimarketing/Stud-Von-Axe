...
- Every hero carries a veil over the photograph. That is not atmosphere but a readability measure: a heading over a photograph does not reach contrast on its own. The client said once that the mares' hero covered too much of the picture, so the veil is lighter in the middle and heavier top and bottom. It is in the template — do not replace it with a flat overlay.
